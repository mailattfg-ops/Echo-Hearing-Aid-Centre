            ...
            {isOpen && (
                <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
                    ...
                    <motion.div
                        ...
                        className="relative w-[95%] sm:w-full max-w-md sm:max-w-lg md:max-w-xl lg:max-w-xl xl:max-w-2xl bg-white rounded-[2rem] sm:rounded-[2.5rem] lg:rounded-[2rem] shadow-2xl overflow-hidden border border-brand-red/10 my-4 max-h-[90vh] overflow-y-auto"
                    >
                        {/* Header */}
                        <div className="bg-brand-red p-6 text-white relative">
                            ...
                            <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-3xl xl:text-3xl font-black mb-1 pr-8 sm:pr-0">Book Hearing Test</h2>
                            <p className="text-sm sm:text-base md:text-lg lg:text-base xl:text-base text-white/80 font-medium italic">Your journey to better hearing starts here.</p>
                        </div>
                        ...
                        <form onSubmit={handleSubmit} className="p-6 sm:p-8 md:p-10 lg:p-8 xl:p-8 flex flex-col gap-4 sm:gap-5 md:gap-6 lg:gap-5">
                            ...
                            <button
                                type="submit"
                                className="w-full bg-brand-dark hover:bg-brand-red text-white py-4 sm:py-5 lg:py-4 xl:py-4 rounded-xl sm:rounded-2xl lg:rounded-2xl font-black text-base sm:text-lg md:text-xl lg:text-lg xl:text-lg transition-all transform hover:-translate-y-1 shadow-xl hover:shadow-brand-red/20 mt-2 md:mt-4 lg:mt-3"
                            >
                                Confirm Appointment
                            </button>
                        </form>
