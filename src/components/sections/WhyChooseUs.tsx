...
export default function WhyChooseUs() {
    return (
        <section className="py-12 lg:py-16 relative overflow-hidden">
            ...
            <div className="absolute bottom-0 right-0 w-96 h-96 bg-[#FF837E]/5 rounded-full translate-x-1/3 translate-y-1/3 blur-3xl opacity-30"></div>
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                    {features.map((feature, idx) => (
                        ...
                        >
                            ...
                            <div className="absolute -right-4 -top-4 w-24 h-24 bg-[#FF837E]/5 rounded-full group-hover:scale-[3] transition-transform duration-700 blur-2xl"></div>
                            ...
                            <div className={`w-16 h-16 rounded-2xl flex items-center justify-center mb-8 group-hover:scale-110 transition-transform duration-500 relative z-10`}>
                                <div className="w-12 h-12 flex items-center justify-center">
                                    <feature.icon size={38} className="text-[#AD0600]" />
                                </div>
                            </div>
                            <h3 className="text-2xl font-bold text-gray-900 mb-4 group-hover:text-[#FF837E] transition-colors relative z-10">{feature.title}</h3>
                            <p className="text-gray-600 leading-relaxed font-medium relative z-10">
                                {feature.desc}
                            </p>

                            <div className="mt-8 overflow-hidden h-1.5 w-0 group-hover:w-full bg-[#FF837E] transition-all duration-500 relative z-10 rounded-full"></div>
                        </motion.div>
                    ))}
                </div>
            </div>
